        ...
        <div class="container">
            ...
            <div class="row counters">
                ...
                <div class="col-lg-6 col-6 text-center">
                    <span data-purecounter-start="0" data-purecounter-end="12665" data-purecounter-duration="1"
                            ...
                            <div class="course-content">
                                ...
                                <div class="trainer d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="trainer-profile d-flex align-items-center">
                                        @auth
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop">Start Learning</button>
                                        @else
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop">Start Learning</button>
                                        @endauth
                                    ...
                                    <div class="trainer-rank d-flex align-items-center">
                                        @for ($i = 0; $i <= ($course['rating'] ?? 0); $i++)
                                            <span id="boot-icon" class="bi bi-star-fill"
                                                style="font-size: 1rem; color: rgb(255, 210, 48);"></span>
                                        @endfor
